...
void ElevatorController::SetGoal(double goal) {
    m_positionProfile =
        TrapezoidalMotionProfile{constraints,
                                 ...
                                 {units::meter_t{m_estimatedPosition}, 0_mps}};
...
void ElevatorController::SetReferences(units::meter_t position,
    ...
    Eigen::Matrix<double, 3, 1> nextR;
    nextR << positionRef, velocityRef, 0;
...
double ElevatorController::UError() const { return m_loop.Xhat(2); }
